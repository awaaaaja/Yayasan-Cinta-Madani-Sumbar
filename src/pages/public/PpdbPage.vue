...
usePageHead({ title: "PPDB", description: "Informasi Penerimaan Peserta Didik Baru Yayasan Cinta Madani." });
...
<template>
  <div>
    <PageHeader title="PPDB" description="Informasi Penerimaan Peserta Didik Baru Yayasan Cinta Madani." />
