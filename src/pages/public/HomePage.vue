...
import SchoolLifeSection from "@/components/sections/SchoolLifeSection.vue";
...
import PpdbCtaSection from "@/components/sections/PpdbCtaSection.vue";
import { usePageHead } from "@/composables/usePageHead";

usePageHead({
  title: "Beranda",
  description: "Yayasan Cinta Madani: menumbuhkan generasi untuk masa depan. Lingkungan pendidikan yang mendukung karakter, potensi, dan masa depan setiap anak.",
});
</script>
