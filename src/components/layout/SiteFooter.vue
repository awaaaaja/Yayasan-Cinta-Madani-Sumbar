      ...
      <div class="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
        ...
        <div class="lg:col-span-4">
          ...
          <p class="text-body text-cream-100/50 max-w-[320px] mb-6">
            Pendidikan yang Membumi dan Menyentuh Hati. Membangun generasi berkarakter, berilmu, dan beramal.
          </p>
        ...
        <div class="lg:col-span-3">
          ...
          <p class="text-sm text-cream-100/50 mb-4">Bergabunglah bersama kami dan mulai perjalanan pendidikan yang bermakna.</p>
          <router-link
            to="/ppdb"
