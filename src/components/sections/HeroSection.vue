    ...
    <template v-else>
      ...
      <div class="relative z-10 w-full container-site py-20 md:py-28 lg:py-32">
        <div class="max-w-[700px]">
          ...
          >
            Menumbuhkan Generasi Berkarakter, Berilmu, dan Beramal.
          </h1>
          ...
          >
            Lingkungan pendidikan Islam yang holistik, menumbuhkan potensi setiap anak dengan penuh kasih sayang.
          </p>
          ...
          >
            <AnimatedButton variant="accent" size="lg" to="/tentang">
              Kenali Yayasan
            </AnimatedButton>
            <AnimatedButton variant="outline" size="lg" to="/unit-pendidikan" class="!border-cream-100/30 !text-cream-100 hover:!bg-cream-100/10">
              Jelajahi Sekolah
            </AnimatedButton>
          </div>
        </div>
