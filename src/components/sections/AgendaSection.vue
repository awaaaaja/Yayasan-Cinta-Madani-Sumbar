...
async function fetchData() {
  ...
  error.value = null;
  try {
    const { listUpcomingEvents } = await import("@/services/events.service");
    events.value = await listUpcomingEvents({ limit: 5 });
  } catch (e) {
  ...
  >
    <div class="container-site">
      ...
      <div v-else>
        ...
        >
          <SectionLabel index="09" label="Agenda" />
          <div class="flex items-end justify-between mb-10 md:mb-14">
            <h2 class="text-h1 text-text">Agenda Mendatang.</h2>
