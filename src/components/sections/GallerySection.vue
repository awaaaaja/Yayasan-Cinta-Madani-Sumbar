...
async function fetchData() {
  ...
  error.value = null;
  try {
    const { listPublishedAlbums } = await import("@/services/gallery.service");
    albums.value = (await listPublishedAlbums({ limit: 6 })) as GalleryAlbum[];
  } catch (e) {
  ...
  >
    <div class="container-site">
      ...
      <div v-else>
        ...
        >
          <SectionLabel index="07" label="Galeri" />
          <div class="flex items-end justify-between mb-10 md:mb-14">
            <h2 class="text-h1 text-text">Galeri Kegiatan.</h2>
